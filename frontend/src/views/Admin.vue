            ...
            <table>
                ...
                <tbody>
                    <tr v-for="ft in data.fixed_tickets" :key="ft.id">
                        <td>{{ ft.name }}</td>
                        <td class="center"><a target="_blank" :href="'https://lockoff.tail00b5c.ts.net/admin/othertickets/' + ft.dl_token + '/qr-code.png'"><img class="qr_code" :src="'https://lockoff-api.gnerd.dk/admin/othertickets/' + ft.dl_token + '/qr-code.png'" /></a></td>
